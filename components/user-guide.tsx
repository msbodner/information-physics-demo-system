      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl space-y-8">
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            AIO/HSL/MRO Demo System V5.0 (current) adds <strong>Exhaustive Live</strong> mode — a chunked map-reduce synthesis path that guarantees full coverage on enumeration queries (&ldquo;list all X&rdquo;, &ldquo;how many Y&rdquo;) — on top of the V4.6 Recall fuzziness improvements, V4.5 retrieval-correctness fixes, and V4.4 R&amp;D Compound HSL Builder. The five ChatAIO modes are now <strong>Recall</strong> (memory-augmented), <strong>Live</strong> (bounded fresh), <strong>Exhaustive Live</strong> (chunked, V5.0), <strong>Broad</strong>, and <strong>Raw</strong>. It converts CSV data into Associated Information Objects (AIOs),
