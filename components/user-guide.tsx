      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl space-y-8">
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            AIO/HSL/MRO Demo System V5.1 (current) ships on top of V5.0&apos;s <strong>Exhaustive Live</strong> mode with a PDF Import freeze fix, a comprehensive <strong>Summarize All</strong> (industry/categories/entities/patterns), persisted PDFs in System Admin, SHA-256 duplicate detection, View Imported PDFs + Create AIOs from PDFs buttons, and a new Bulk HSL Process technote. The five ChatAIO modes are unchanged: <strong>Recall</strong> (memory-augmented), <strong>Live</strong> (bounded fresh), <strong>Exhaustive Live</strong> (chunked), <strong>Broad</strong>, and <strong>Raw</strong>. It converts CSV data into Associated Information Objects (AIOs),
