      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl space-y-8">
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            AIO Generator V3.4 adds the R &amp; D Compound HSL Builder and Information Elements tracking to the production platform. It converts CSV data into Associated Information Objects (AIOs),
