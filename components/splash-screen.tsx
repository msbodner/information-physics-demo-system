    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
      ...
      <header className="border-b border-border bg-card">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-xs font-mono text-muted-foreground">V4.1</div>
          </div>
        </div>
      </header>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-5xl font-bold text-foreground mb-3">AIO/HSL/MRO Demo System V4.1</h2>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            V4.1 — Full dashboard with live data, sidebar navigation, and AI-powered retrieval
          </p>
        </div>
      </section>
