        ...
        <article className="prose prose-sm dark:prose-invert max-w-none">
          ...
          <Card className="mb-10">
            ...
            <CardContent className="text-sm leading-relaxed text-muted-foreground space-y-3">
              <p>Bulk HSL Build is the tenant-wide reconstruction function for the Hyper-Semantic Layer (HSL). Its job is to scan every Associated Information Object (AIO) belonging to a single tenant, identify the <code className="bg-muted px-1 rounded">[Key.Value]</code> elements that two or more AIOs share, and emit one HSL pointer record per shared element group. The result is a precomputed, deterministic, query-time-ready relational layer that Live Search (formerly AIO Search) and Recall Search (formerly Substrate) modes use to traverse the corpus without any embedding store, vector index, or graph database.</p>
