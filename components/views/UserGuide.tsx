        ...
        <div className="grid lg:grid-cols-[240px_1fr] gap-8">
          ...
          <div className="space-y-6">
            ...
            {activeSection === "overview" && (
              <Card><CardHeader><CardTitle className="flex items-center gap-2"><Globe className="w-5 h-5" />Overview — AIO/HSL/MRO Demo System V4.6</CardTitle></CardHeader>
              <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                <p>AIO/HSL/MRO Demo System V4.6 converts CSV files into <strong>Associated Information Objects (AIOs)</strong> — the fundamental unit of the Information Physics Standard Model. Each CSV row becomes a single self-describing AIO string, stored in a PostgreSQL database and searchable through the Hyper-Semantic Processor.</p>
                <p><strong>What V4.6 changes:</strong> a Recall-quality release. V4.5 closed the &ldquo;Recall under-counts on aggregations&rdquo; gap; V4.6 closes the &ldquo;Recall under-resolves on typos / fuzzy queries&rdquo; gap. Recall now matches Live on typo-laden queries (&ldquo;Sara Mitchel&rdquo;, &ldquo;Texis&rdquo;, &ldquo;Perkins Will&rdquo;) via three additive layers: a <strong>typo-tolerant Pass 1d</strong> in cue extraction, a new <strong>Thorough Recall</strong> toggle that augments cues with Live-quality LLM-parsed search terms, and a backend trigram path with <strong>bidirectional substring fallback</strong>. Plus the substrate-chat answer prompt was rewritten 1:1 to mirror Live&apos;s prompt, so output structure now matches too. See <strong>Recall vs. Live — Operator Decision Guide</strong> in References for the full mechanism.</p>
                <h4 className="text-foreground font-medium mt-4">What&apos;s New in V4.6</h4>
