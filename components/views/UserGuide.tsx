        ...
        <div className="grid lg:grid-cols-[240px_1fr] gap-8">
          ...
          <div className="space-y-6">
            ...
            {activeSection === "overview" && (
              <Card><CardHeader><CardTitle className="flex items-center gap-2"><Globe className="w-5 h-5" />Overview — AIO/HSL/MRO Demo System V4.5</CardTitle></CardHeader>
              <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                <p>AIO/HSL/MRO Demo System V4.5 converts CSV files into <strong>Associated Information Objects (AIOs)</strong> — the fundamental unit of the Information Physics Standard Model. Each CSV row becomes a single self-describing AIO string, stored in a PostgreSQL database and searchable through the Hyper-Semantic Processor.</p>
                <p><strong>What V4.5 changes:</strong> a retrieval-quality + operability release. The four ChatAIO modes are unchanged; the work is in keeping retrieval honest at scale (per-CSV diversity cap, HSL field-name aliasing, HSL inverted-index fix in migration 029) and in giving operators in-app controls (runtime LLM model selection, daily token budget UI, R&amp;D Benchmark buttons, inline document viewer for technical reports). See the new sections below and the <strong>Technical Notes — Live Search vs. Recall Search</strong> reference paper §9 for the retrieval-fix details.</p>
                <h4 className="text-foreground font-medium mt-4">What&apos;s New in V4.5</h4>
