        ...
        <div className="grid lg:grid-cols-[240px_1fr] gap-8">
          ...
          <div className="space-y-6">
            ...
            {activeSection === "overview" && (
              <Card><CardHeader><CardTitle className="flex items-center gap-2"><Globe className="w-5 h-5" />Overview — AIO/HSL/MRO Demo System V5.0</CardTitle></CardHeader>
              <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                <p>AIO/HSL/MRO Demo System V5.0 converts CSV and PDF files into <strong>Associated Information Objects (AIOs)</strong> — the fundamental unit of the Information Physics Standard Model. Each row becomes a single self-describing AIO string, stored in a PostgreSQL database and searchable through the Hyper-Semantic Processor.</p>
                <p><strong>What V5.0 changes:</strong> a completeness release. V4.5 closed the &ldquo;Recall under-counts on aggregations&rdquo; gap; V4.6 closed the &ldquo;Recall under-resolves on typos / fuzzy queries&rdquo; gap; V5.0 closes the &ldquo;Live silently truncates on enumeration queries&rdquo; gap with a new <strong>Exhaustive Live</strong> mode and adds an opt-in <strong>Smart Search</strong> auto-mode classifier so the system picks the best of five search modes for each query. Costs more tokens on enumerations (~N × Live); operator picks the per-chunk classifier (Haiku default, Sonnet/Opus available). See <strong>Search Modes Compendium V5.0</strong> in References for the full reference and decision matrix.</p>

                <h4 className="text-foreground font-medium mt-4">What&apos;s New in V5.0 — operator-facing features</h4>
