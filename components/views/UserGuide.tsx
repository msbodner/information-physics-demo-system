          ...
          <div className="space-y-6">
            ...
            {activeSection === "overview" && (
              ...
              <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                <p>AIO/HSL/MRO Demo System V5.0 converts CSV files into <strong>Associated Information Objects (AIOs)</strong> — the fundamental unit of the Information Physics Standard Model. Each CSV row becomes a single self-describing AIO string, stored in a PostgreSQL database and searchable through the Hyper-Semantic Processor.</p>
                <p><strong>What V5.0 changes:</strong> a completeness release. V4.5 closed the &ldquo;Recall under-counts on aggregations&rdquo; gap; V4.6 closed the &ldquo;Recall under-resolves on typos / fuzzy queries&rdquo; gap; V5.0 closes the &ldquo;Live silently truncates on enumeration queries&rdquo; gap. The new <strong>Exhaustive Live</strong> mode runs Live&apos;s phases 1–3 unchanged and then performs a chunked map-reduce synthesis: every matched AIO is processed by per-chunk LLM classification with strict JSON output, then merged in-Python by max similarity. Operators get <strong>guaranteed completeness</strong> on &ldquo;list all X / how many Y&rdquo; queries that V4.6 Live could silently shortlist. Costs more tokens (~N × Live); operator picks the per-chunk classifier (Haiku default, Sonnet/Opus available). See <strong>Search Modes Compendium V5.0</strong> in References for the full reference and decision matrix.</p>
                <h4 className="text-foreground font-medium mt-4">What&apos;s New in V5.0</h4>
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li><strong>Cache-namespace separation.</strong> Exhaustive replies cache under <code className="bg-muted px-1 rounded">aio-search-exhaustive</code>, isolated from Live&apos;s <code className="bg-muted px-1 rounded">aio-search</code> namespace. A Live cache hit can&apos;t shadow an Exhaustive request and vice-versa. Cache-store gated on <code className="bg-muted px-1 rounded">coverage == 1.0</code> so partial replies never get re-served as if they were complete.</li>
