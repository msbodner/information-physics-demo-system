...
HSL traversal:
  ...
  Match: exact on selected semantic dimensions.`}
          ...
          <Section num={7} title="Implementation in V4.0">
          ...
          <Section num={8} title="Conclusion">
            ...
            <p>With V4.0 and Substrate Mode, the substrate is now live. Claude reads from it natively.</p>
          </Section>
