...
from api.routes.imported_pdfs import router as imported_pdfs_router
...
app.include_router(imported_pdfs_router)   # /v1/imported-pdfs — persisted PDF originals (V5.0+)
